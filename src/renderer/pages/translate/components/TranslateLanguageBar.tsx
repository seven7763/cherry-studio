        ...
        <>
          ...
          <Tooltip content={t('translate.exchange.label')} placement="bottom">
            <Button
              ...
              className="h-8 w-8 shrink-0 rounded-full text-foreground/80 shadow-none transition-all hover:bg-accent hover:text-foreground active:scale-90 [&_svg]:[stroke-width:var(--icon-stroke)]">
