...
const Item = ({
  ...
  <div
    ...
    className={cn(
      'group/action-item mb-2 flex min-h-9 cursor-move items-center justify-between rounded-lg border border-border-muted bg-transparent px-4 py-1.5 transition-colors last:mb-0 hover:border-border hover:bg-muted/50',
