...
sessionActionRegistry.registerAction({
  ...
  icon: ({ pinned }) => (pinned ? <PinOffIcon className="size-3.5" /> : <PinIcon className="size-3.5" />),
  order: 30,
  surface: 'menu'
})
...
sessionActionRegistry.registerAction({
  ...
  icon: () => <OpenInNewWindowIcon className="size-3.5 [stroke-width:var(--icon-stroke)]" />,
  order: 37,
  surface: 'menu'
})
...
sessionActionRegistry.registerAction({
  ...
  icon: () => <DeleteIcon className="size-3.5 lucide-custom [stroke-width:var(--icon-stroke)]" />,
  group: 'danger',
  order: 90,
  surface: 'menu',
  danger: true,
