      ...
      {open && children && (
        <motion.div
          ...
          <div
            ...
            <div className="absolute top-0 right-0 h-full w-0.5 bg-control-accent/20 opacity-0 transition-opacity group-hover/resource-list-resize-handle:opacity-100 group-data-[resizing=true]/resource-list-pane:bg-control-accent/35 group-data-[resizing=true]/resource-list-pane:opacity-100" />
          </div>
        </motion.div>
      )}
    </AnimatePresence>
