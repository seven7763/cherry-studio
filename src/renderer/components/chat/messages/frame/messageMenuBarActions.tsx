...
registerToolbarAction({
  ...
  icon: ({ copied }) => (copied ? <Check size={15} color="var(--color-control-accent)" /> : <CopyIcon size={15} />),
...
registerToolbarAction({
  ...
  icon: ({ isUseful }) =>
    isUseful ? <ThumbsUp size={17.5} fill="var(--color-control-accent)" strokeWidth={0} /> : <ThumbsUp size={15} />,
