...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role="group"
      className={cn(
        'group/input-group border-[color:var(--color-border-fg-muted)] bg-transparent relative flex w-full items-center rounded-lg border transition-[color,box-shadow] outline-none',
        'h-8 min-w-0 px-2.5 has-[>textarea]:h-auto',
        ...
        // Focus state.
        'has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-ring/35 has-[[data-slot=input-group-control]:focus-visible]:ring-[1px]',
